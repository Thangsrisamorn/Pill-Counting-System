...
SOURCE_FOLDERS = [
    r"C:\Users\Admin\Desktop\Project\pillwebcam\capsule",  
    r"C:\Users\Admin\Desktop\Project\pillwebcam\oval", 
    r"C:\Users\Admin\Desktop\Project\pillwebcam\square"   
]
TRAIN_RATIO = 0.8  
...
for folder_path in SOURCE_FOLDERS:
    ...
    if not os.path.exists(src_img_dir):
        print(f" ข้ามโฟลเดอร์ '{folder_name}' (หาโฟลเดอร์ images ไม่เจอ)")
        continue
